        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-900/10 bg-white p-6 shadow-sm shadow-slate-900/5 dark:border-slate-200/10 dark:bg-white/5 dark:shadow-none">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300/80">
              Header fixo com links para Benefícios, Como funciona e Prova social. Em /contato, os links levam de volta para a
              home com hash.
            </p>
          </div>
          <div className="rounded-2xl border border-slate-900/10 bg-white p-6 shadow-sm shadow-slate-900/5 dark:border-slate-200/10 dark:bg-white/5 dark:shadow-none">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300/80">
              Validação no cliente e envio via <span className="font-mono text-cyan-700/90 dark:text-cyan-200/90">mailto:</span>.
              Você pode plugar um backend depois sem mudar o design.
            </p>
          </div>
        </div>
      </Container>
